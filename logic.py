...
class DB_Manager:
    ...
    def get_statuses(self):
        sql = "SELECT * FROM status" # Запиши сюда правильный SQL запрос
    ...
    def get_projects(self, user_id):
        sql = "SELECT project_id, project_name, description, url, status_id FROM projects WHERE user_id = ?" # Запиши сюда правильный SQL запрос
...
"""
    ...
    def update_projects(self, param, data):
        sql = f"UPDATE projects SET {param} = ? WHERE user_id = ? AND project_id = ?" # Запиши сюда правильный SQL запрос
        self.__executemany(sql, [data]) 
