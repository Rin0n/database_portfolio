...
/projects - используй для просмотра всех твоих проектов
Также ты можешь ввести имя проекта и узнать информацию о нем!""")
    

@bot.message_handler(commands=['new_project']) # команда для добавления нового проекта
...
@bot.message_handler(commands=['skills']) # команда для добавления навыков к проекту
...
@bot.message_handler(commands=['projects']) # команда для просмотра всех проектов
...
@bot.message_handler(commands=['delete']) # команда для удаления проекта
...
@bot.message_handler(commands=['update_projects']) # команда для обновления информации о проекте
